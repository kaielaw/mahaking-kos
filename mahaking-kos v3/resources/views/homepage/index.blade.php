...
<section class="hero">
    ...
    <div class="hero-features">
        <div class="feat-item">
            ...
            <span class="feat-label highlight">Harga Terjangkau</span>
        </div>
        <div class="feat-item">
            <div class="feat-icon">
        ...
        <div class="feat-item">
            <div class="feat-icon">
                <img src="/images/location.svg" alt="" onerror="this.style.display='none';this.nextElementSibling.style.display='block'">
